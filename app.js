...
const riskAssessments = {
  ...
  Transport: [
    ...
    { code: 'WP-004', title: 'Screens — Operation, Blockage Clearance and Media Change', doc: 'docs/WP-004-Screens-Operation-Blockage-Clearance-and-Media-Change.pdf' },
    { code: 'WP-005', title: 'Cyclones / EvoWash Sand Plant — Operation & Apex/Spigot Change', doc: 'docs/WP-005-Cyclones-EvoWash-Sand-Plant-Operation-Apex-Spigot-Change.pdf' },
    { code: 'WP-006', title: 'Thickener — Operation, Rake Torque and Flocculant Dosing', doc: 'docs/WP-006-Thickener-Operation-Rake-Torque-and-Flocculant-Dosing.pdf' },
    { code: 'WP-007', title: 'Filter Press — Operation and Cloth Change', doc: 'docs/WP-007-Filter-Press-Operation-and-Cloth-Change.pdf' },
    { code: 'WP-008', title: 'Water Circuit — Pumps, Tanks and Ring Main', doc: 'docs/WP-008-Water-Circuit-Pumps-Tanks-and-Ring-Main.pdf' },
    { code: 'WP-009', title: 'Conveyors — Stockpile Discharge', doc: 'docs/WP-009-Conveyors-Stockpile-Discharge.pdf' },
    { code: 'WP-010', title: 'Motor Control Centre and Electrical Isolation', doc: 'docs/WP-010-Motor-Control-Centre-and-Electrical-Isolation.pdf' },
    { code: 'WP-011', title: 'Confined Space Entry — Thickener, Sumps, Buffer Tanks, Hoppers', doc: 'docs/WP-011-Confined-Space-Entry-Thickener-Sumps-Buffer-Tanks-Hoppers.pdf' },
    { code: 'WP-012', title: 'Working at Height on the Wash Plant — Cyclone Tower, Screen Decks, Filter Press Platforms', doc: 'docs/WP-012-Working-at-Height-on-the-Wash-Plant-Cyclone-Tower-Screen-Decks-Filter-Press-Platforms.pdf' },
    { code: 'WP-013', title: 'Hot Works on the Wash Plant — Welding, Cutting, Grinding', doc: 'docs/WP-013-Hot-Works-on-the-Wash-Plant-Welding-Cutting-Grinding.pdf' },
  ],
};
    ...
    items: [
      {
        ...
        manager: 'James Smalley',
        role: 'Appointed Supervisor',
        effective: 'Effective 8 April 2025',
        doc: 'docs/James-Smalley-Tong-Quarry-8-1-D.pdf',
      },
      {
        code: 'REG 8(1)(D)',
        ...
        role: 'Appointed Supervisor',
        effective: 'Effective 8 April 2025',
        doc: 'docs/Tom-Inman-Ellel-Quarry-8-1-D.pdf',
      },
      {
        code: 'REG 8(1)(D)',
        title: 'Lydiate Lane Quarry — Supervisor Appointment',
        manager: 'Piotr Slojewski',
        role: 'Appointed Supervisor',
        effective: 'Effective 8 April 2025',
        doc: 'docs/Piotr-Slojewski-Lydiate-Lane-8-1-D.pdf',
      },
      {
        code: 'REG 8(1)(D)',
        title: 'Woods Waste Landfill — Supervisor Appointment',
        manager: 'Richard Semple',
        role: 'Appointed Supervisor',
        effective: 'Effective 8 April 2025',
        doc: 'docs/Richard-Semple-Woods-Waste-Landfill-8-1-D.pdf',
      },
    ],
  },
  {
